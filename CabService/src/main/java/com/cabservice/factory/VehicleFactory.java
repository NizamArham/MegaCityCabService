...
public class VehicleFactory {
    public static Vehicle createVehicle(String vehicleType, String brand, String model, String fuelType, int powersourceCapacity, String color, String numberPlate, int seatCapacity, String cabClass) {
        switch (vehicleType.toLowerCase()) {
            ...
            case "Bike":
                return new Bike(brand, model, fuelType, powersourceCapacity, color, numberPlate, seatCapacity, cabClass);
            case "Bus":
                return new Bus(brand, model, fuelType, powersourceCapacity, color, numberPlate, seatCapacity, cabClass);
            case "Car":
                return new Bus(brand, model, fuelType, powersourceCapacity, color, numberPlate, seatCapacity, cabClass);
            default:
